...
if("TRUE" STREQUAL "TRUE")
  set(dynamixel_controllers_SOURCE_PREFIX /home/ubuntu/lab3/src/dynamixel_motor/dynamixel_controllers)
  set(dynamixel_controllers_DEVEL_PREFIX /home/ubuntu/lab3/devel)
  ...
  set(dynamixel_controllers_INSTALL_PREFIX /home/ubuntu/lab3/install)
...
if(NOT "/home/ubuntu/lab3/devel/include " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/dynamixel_controllers " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/dynamixel_controllers' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'dynamixel_controllers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'dynamixel_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/lab3/src/dynamixel_motor/dynamixel_controllers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT dynamixel_controllers_NUM_DUMMY_TARGETS)
      set(dynamixel_controllers_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::dynamixel_controllers::wrapped-linker-option${dynamixel_controllers_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR dynamixel_controllers_NUM_DUMMY_TARGETS "${dynamixel_controllers_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::dynamixel_controllers::wrapped-linker-option${dynamixel_controllers_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND dynamixel_controllers_LIBRARIES "${interface_target_name}")
...
set(dynamixel_controllers_EXPORTED_TARGETS "dynamixel_controllers_generate_messages_cpp;dynamixel_controllers_generate_messages_eus;dynamixel_controllers_generate_messages_lisp;dynamixel_controllers_generate_messages_nodejs;dynamixel_controllers_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${dynamixel_controllers_dep}_FOUND)
      find_package(${dynamixel_controllers_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${dynamixel_controllers_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(dynamixel_controllers_EXPORTED_TARGETS ${${dynamixel_controllers_dep}_EXPORTED_TARGETS})
endforeach()
