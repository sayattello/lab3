// Generated by gencpp from file dynamixel_controllers/StartControllerResponse.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_CONTROLLERS_MESSAGE_STARTCONTROLLERRESPONSE_H
#define DYNAMIXEL_CONTROLLERS_MESSAGE_STARTCONTROLLERRESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_controllers::StartControllerResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_controllers::StartControllerResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dynamixel_controllers::StartControllerResponse_<ContainerAllocator1> & lhs, const ::dynamixel_controllers::StartControllerResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::dynamixel_controllers::StartControllerResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_controllers::StartControllerResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_controllers::StartControllerResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_controllers::StartControllerResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_controllers::StartControllerResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_controllers::StartControllerResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_controllers::StartControllerResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_controllers::StartControllerResponse_<ContainerAllocator>& v)
  {
    s << indent << "success: ";
...
#endif // DYNAMIXEL_CONTROLLERS_MESSAGE_STARTCONTROLLERRESPONSE_H
