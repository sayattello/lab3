...
bool operator==(const ::dynamixel_controllers::RestartControllerRequest_<ContainerAllocator1> & lhs, const ::dynamixel_controllers::RestartControllerRequest_<ContainerAllocator2> & rhs)
{
