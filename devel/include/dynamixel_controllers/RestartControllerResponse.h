...
bool operator==(const ::dynamixel_controllers::RestartControllerResponse_<ContainerAllocator1> & lhs, const ::dynamixel_controllers::RestartControllerResponse_<ContainerAllocator2> & rhs)
{
