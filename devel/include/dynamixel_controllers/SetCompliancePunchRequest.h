...
bool operator==(const ::dynamixel_controllers::SetCompliancePunchRequest_<ContainerAllocator1> & lhs, const ::dynamixel_controllers::SetCompliancePunchRequest_<ContainerAllocator2> & rhs)
{
  return lhs.punch == rhs.punch;
}
