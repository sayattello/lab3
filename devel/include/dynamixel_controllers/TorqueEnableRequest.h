...
bool operator==(const ::dynamixel_controllers::TorqueEnableRequest_<ContainerAllocator1> & lhs, const ::dynamixel_controllers::TorqueEnableRequest_<ContainerAllocator2> & rhs)
{
