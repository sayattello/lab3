// Generated by gencpp from file dynamixel_controllers/StopControllerResponse.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_CONTROLLERS_MESSAGE_STOPCONTROLLERRESPONSE_H
#define DYNAMIXEL_CONTROLLERS_MESSAGE_STOPCONTROLLERRESPONSE_H
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_controllers::StopControllerResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_controllers::StopControllerResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dynamixel_controllers::StopControllerResponse_<ContainerAllocator1> & lhs, const ::dynamixel_controllers::StopControllerResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::dynamixel_controllers::StopControllerResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_controllers::StopControllerResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_controllers::StopControllerResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_controllers::StopControllerResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_controllers::StopControllerResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_controllers::StopControllerResponse_<ContainerAllocator> const>
  : FalseType
  { };
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_controllers::StopControllerResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_controllers::StopControllerResponse_<ContainerAllocator>& v)
  {
    s << indent << "success: ";
...
#endif // DYNAMIXEL_CONTROLLERS_MESSAGE_STOPCONTROLLERRESPONSE_H
