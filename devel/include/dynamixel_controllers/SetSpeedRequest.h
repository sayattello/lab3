...
bool operator==(const ::dynamixel_controllers::SetSpeedRequest_<ContainerAllocator1> & lhs, const ::dynamixel_controllers::SetSpeedRequest_<ContainerAllocator2> & rhs)
{
