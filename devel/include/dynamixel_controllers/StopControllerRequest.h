...
bool operator==(const ::dynamixel_controllers::StopControllerRequest_<ContainerAllocator1> & lhs, const ::dynamixel_controllers::StopControllerRequest_<ContainerAllocator2> & rhs)
{
